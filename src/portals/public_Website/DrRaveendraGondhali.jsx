...
const CONFIG = {
  ...
  specialty: "Gynecologist & Obstretics,",
  specialty1: "Infertility & IVF MS(OBGY),",
  specialty2: "MBBS, F.MAS Obstetrics & Gynecology",
          ...
          <div className="hero-text">
            ...
            <div className="specialty">{CONFIG.credentials} </div>
             <div className="cred-spec">{CONFIG.specialty}</div>
               ...
               <div className="cred-spec">{CONFIG.specialty2}</div>
                <div className="grid2">
